...
const fallbackTexture = textureLoader.load("/images/placeholder.webp");
...
const TechStack = () => {
  ...
  const materials = useMemo(() => {
    return textures.map((texture) => {
      const isLoaded = texture.image !== undefined && texture.image !== null;
      const activeTexture = isLoaded ? texture : fallbackTexture;
